...
document.querySelector('.auto-play-button').
   addEventListener('click',()=> {
    ...
    if(stopButton.innerHTML === 'Auto Play') {
  ...
  function textButton() {
    const yesButton =  document.querySelector('.js-button-text').innerHTML = 
        `Are you sure you want to reset the score?  
        <button class="yes-button">Yes</button> <button class="no-button">No</button>`

  }

  //Clicking to reset the button
  ...
  function removeTextButton() {
    document.querySelector('.js-button-text').innerHTML = ''
  }
